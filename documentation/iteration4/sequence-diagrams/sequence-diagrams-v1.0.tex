...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{diagrams/edit-flight.png}
\end{figure}

\section{Διαχείρηση Μenu}
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{diagrams/menu_useCase.png}
\end{figure}

\section{Διαχείρηση Αναφορών Πιλότων}
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{diagrams/pilot_reports.png}
\end{figure}

\section{Airport}
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{diagrams/airport_logs.png}
\end{figure}

\section{Employee}
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{diagrams/employee_logs.png}
\end{figure}

\section{Airplane}
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{diagrams/airplane_logs.png}
\end{figure}

\section{Maintenance}
Editor: Ελευθερία Γιαννοπούλου
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{diagrams/ticket_selling_useCase.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{diagrams/maintenance_useCase.png}
\end{figure}

\section{Contractors}
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{diagrams/contractor.png}
\end{figure}
